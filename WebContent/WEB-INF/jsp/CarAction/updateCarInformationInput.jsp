...
/* $(function(){
	 ...
	 $("select option").each(function(){
	  ...
	  var purchaseDateTime = $(".purchaseDate").val();
	 var purchaseDate = new Date(purchaseDateTime);
	 $(".purchaseDate").val(dateFormat(purchaseDate,'yyyy-mm-dd')); 
}); */
//判断输入框的内容不能为空和只填空格
...
<div id="message">
    <div class="p-detail">
    	<p><font color="red">带*号的为必填项，其他的为选填项 <!-- <font color="green"> 档案号和车牌号不可修改</font> --></font></p>
        <p>当前位置&nbsp;:&nbsp;&nbsp;<a href="#">信息录入</a>>><a href="#">车辆信息修改</a></p>
       </div>
       <div id="line"></div>
       <div id="demo">
<form class="jqtransform" id="carInformationInput" action="carInformation_updateCarSuccess.action?currentPage=${sessionScope.currentPage }" method="post">
	<div><p>车辆类型：</p>
		 <select name="carType" onchange="sameCapacity(this)" id="carType">
    ...
    <div><p>*车主：</p><input type="text" name="carOwner" value="${carOwner }" onblur="judgeNotNull(this)"/><label style="font:bold;color: red" hidden>请输入内容，不能为空</label></div>
    <div><p>*档案号：</p><input type="text" id="fileNum" name="fileNum" value="${fileNum }" readonly="readonly"/><br/></div>
    <div><p>地址：</p><input type="text" name="address" value="${address }"/></div>
    <div><p>*车牌号码：</p><input maxlength="7" type="text" name="carNum" value="${carNum }" id="carNum"/></div>
    <div><p>营运证号：</p><input type="text" name="businessNum" value="${businessNum }"/></div>
	<div><p>*厂牌型号：</p><input type="text" name="factoryNum" value="${factoryNum }" onblur="judgeNotNull(this)"/><label style="font:bold;color: red"  hidden>请输入内容，不能为空</label></div>
    <div><p>出厂日期：</p><input type="text" name="purchaseDate" class="purchaseDate" value="${purchaseDate }"/></div>
    
    
    <div><p>*车辆容量：</p><input type="text" name="capacity" value="${capacity} " onblur="capacityJudgeNotNull(this)" onfocus="capacityFocus()"/><label id="capacityTon" hidden>吨</label><label id="capacitySit" hidden>座</label><label id="capacityNull" style="font:bold;color: red" hidden>请输入内容，不能为空</label><label id="trueNumOnly" style="font:bold;color: red" hidden>请重新输入正整数</label></div>
    <div><p>*发动机号：</p><input type="text" name="engineNum" value="${engineNum }" onblur="judgeNotNull(this)"/><label style="font:bold;color: red"  hidden>请输入内容，不能为空</label></div>
    <div><p>*底盘号：</p><input type="text" name="chassisNum" value="${chassisNum }" onblur="judgeNotNull(this)"/><label style="font:bold;color: red"  hidden>请输入内容，不能为空</label></div>
    <div><p>外观颜色：</p><input type="text" name="color" value="${color }"/></div>
    <div><p>*联系手机号码：</p><input type="text" name="phoneNum" value="${phoneNum }" id="phoneNum" onblur="phoneNumBeSure(this)" onfocus="phoneNumFocus(this)"/><label id="phoneNumNotNull" style="font:bold;color: red" hidden>请输入内容，不能为空</label><label id="phoneNumSize" style="font:bold;color: red" hidden>手机号码格式不正确,位数不足<span style="color: black;font-family: monospace;font-size: x-large;">十一</span>位，请重新输入</label></div>
    <input type="text" name="status" value="1" hidden/>
    <input type="text" name="id" value="${id }" hidden/>
    <div class="button"><input id="confirmAllValue" onclick="afterSubmitAll(this)" type="button" value="提交"/><input type="reset" value="重置"/></div>
...
<div id="message">
    <div class="p-detail">
    	<p><font color="red">带*号的为必填项，其他的为选填项 <!-- <font color="green"> 档案号和车牌号不可修改</font> --></font></p>
        <p>当前位置&nbsp;:&nbsp;&nbsp;<a href="#">信息录入</a>>><a href="#">车辆信息录入</a></p>
       </div>
       <div id="line"></div>
       <div id="demo">
<form class="jqtransform" id="carInformationInput" action="carInformation_updateCarSuccessFuzzy.action?currentPage=${sessionScope.currentPage }" method="post">
	<div><p>车辆类型：</p>
		 <select name="carType" onchange="sameCapacity(this)" id="carType">
		 	<option value="${carType }" selected="selected">${carType }</option>
			<option value ="货运">货运</option>
    ...
    <input type="text" name="status" value="1" hidden/>
    <input type="text" name="id" value="${id }" hidden/>
    <div class="button"><input id="confirmAllValue" onc
    lick="afterSubmitAll(this)" type="button" value="提交"/><input type="reset" value="重置"/></div>
